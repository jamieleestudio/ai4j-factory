...
public class TimeTool {
    ...
    @McpResource(
            uri = "spec://evolvableMonolithRules",
            name = "Evolvable Modular Monolith Architecture Rules",
            description = "List available specs"
    )
    public String evolvableMonolithRules() {
        return """
    ...
    public McpSchema.ReadResourceResult readSpec(String name) throws IOException {
    ...
    private McpSchema.ReadResourceResult errorResource(String uri, String code, String message) {
        String json = """
                {
                  "code": "%s",
                  "message": "%s"
