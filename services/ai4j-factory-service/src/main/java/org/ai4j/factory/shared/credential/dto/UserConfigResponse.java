...
public class UserConfigResponse {
    ...
    public ModelCredentialResponse getCredential() { return credential; }
    public void setCredential(ModelCredentialResponse credential) { this.credential = credential; }
    public ModelConfigResponse getConfig() { return config; }
    public void setConfig(ModelConfigResponse config) { this.config = config; }
